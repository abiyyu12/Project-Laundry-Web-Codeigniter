...
class TransaksiKiloan extends BaseController
{
    private $adminModel;
    private $cabangModel;
    ...
    public function index()
    {
      ...
      return view('admin/transaksi-kiloan/index',$data);
    }
    ...
    public function new()
    {
        ...
        return view('admin/Transaksi-Kiloan/create',$data);
    }
    ...
    public function create()
    {
        if(!$this->validate([
            ...
            return redirect()->to('/admin/transaksi-kiloan/new')->withInput()->with('validation',$validation);
        }
        ...
        return redirect()->to(site_url('admin/transaksi-kiloan'))->with('success','Data transaksi kiloan berhasil disimpan');
    }
    ...
    public function edit($id = null)
    {
        if($id != null){
            ...
            $data = [
                ...
                'transaksi_kiloan' => $this->transaksiModel->find($id)
            ];
            $data['pelanggan'] = $this->pelangganModel->findAll();
            $data['admin'] = $this->adminModel->findAll();
            $data['cabang'] = $this->cabangModel->findAll();
            return view('admin/transaksi-kiloan/edit',$data);
            }
            else{
    ...
    public function update()
    {
        ...
        if(!$this->validate([
            ...
            $validation =  ['errors' => $this->validator->getErrors()];
            return redirect()->to('/admin/transaksi-kiloan/'.$id_transaksi.'/edit')->withInput()->with('validation',$validation);
        }
        if($this->request->getPost('id_cabang') == 'pusat'){
          $id_cabang = null;
        }else{
        ...
        $this->transaksiModel->save($data);
        return redirect()->to(site_url('admin/transaksi-kiloan'))->with('success','Data transaksi kiloan berhasil diubah');
    }

    public function delete($id = null)
    {
        $this->transaksiModel->delete($id);
        return redirect()->to(site_url('admin/transaksi-kiloan'))->with('error','Data berhasil dihapus');
    }
    ...
    public function export_excel(){
        ...
        header('Content-Disposition: attachment;filename=Transaksi-Kiloan.xlsx');
    ...
    public function export_pdf(){
      $keyword = $this->request->getGet('keyword');
      $data['TransaksiKiloan'] = $this->transaksiModel->getSearchDocument($keyword);
      $domPdf = new Dompdf();
      $html = view('admin/transaksi-kiloan/print_pdf',$data);
