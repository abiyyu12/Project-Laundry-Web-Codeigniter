...
<?= $this->section('title') ?>
<title>Tambah Transaksi Satuan &mdash; Mawar-laundry</title>
<?= $this->endSection(); ?>
...
<section class="section">
          <div class="section-header">
            ...
            <h1>Tambah Transaksi Satuan</h1>
          </div>
          <div class="section-body">
              <div class="card">
                <div class="card-header">
                    <h4>Buat Transkasi Satuan Baru</h4>
                </div>
                <div class="card-body col-md-8">
                    <form action="<?= base_url('/admin/transaksi-satuan') ?>" method="post" autocomplete="off">
                      <?= csrf_field() ?>
