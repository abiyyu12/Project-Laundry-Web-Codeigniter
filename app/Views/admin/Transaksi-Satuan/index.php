...
<?= $this->section('title') ?>
<title>Data Transaksi Satuan &mdash; Mawar-laundry</title>
<?= $this->endSection(); ?>
<?= $this->section('content') ?>
<section class="section">
          <div class="section-header">
            <h1>Transaksi Satuan</h1>
            <div class="section-header-button">
              <a href="<?= base_url('admin/transaksi-satuan/new') ?>" class="btn btn-primary">Tambah Transaksi Satuan</a>
            </div>
          </div>
                  <?php 
          ...
          <div class="section-body">
                <div class="card">
                  <div class="card-header">
                    <h4>Data Transaksi Satuan Mawar-laundry</h4>
                  </div>
                  <div class="card-header">
                    <form method="get" action="" autocomplete="off">
                        ...
                        ?>
                          <a href="<?= site_url('admin/transaksi-satuan/export-excel'.$param) ?>" class="btn btn-primary ml-2"><i class="fas fa-file-excel"></i> Export Excel</a>
                          <a href="<?= site_url('admin/transaksi-satuan/export-pdf'.$param) ?>" class="btn btn-danger ml-2"><i class="fas fa-file-pdf"></i> Export PDF</a>
                        </div>
                    </form>
                  </div>      
                      ...
                      <table class="table table-striped table-md">
                        ...
                        <tbody>
                          <?php
                           ...
                           $no = 1 + (10 * ($page - 1));
                           foreach($TransaksiSatuan as $key => $value) : ?>
                          <tr>
                            <td><?= $no++ ?></td>
                            ...
                            <td class="text-center" style="width: 15%;">
                              <a href="<?= site_url('/admin/transaksi-satuan/'.$value->id_transaksi.'/edit') ?>" class="btn btn-warning btn-sm"><i class="fas fa-pencil-alt"></i></a>
                              <!-- <a href="#" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a> -->
                              <form action="<?= site_url('admin/transaksi-satuan/'.$value->id_transaksi.'/delete') ?>" id="del-<?=$value->id_transaksi?>" method="post" class="d-inline">
                              <?= csrf_field() ?>
                              ...
                              <a href="<?= site_url('/admin/'.$value->id_transaksi.'/detail-satuan') ?>" class="btn btn-info btn-sm"><i class="fas fa-info"></i></a>
                          </td>
                          </tr>
                          <?php endforeach; ?>
                        </tbody>
