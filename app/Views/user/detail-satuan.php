...
<?= $this->section('title') ?>
<title>Mawar Laundry | detail-satuan</title>
<?= $this->endSection(); ?>
    ...
    <div class="container mb-5 mt-5">
      ...
      <div class="container" style="background-color: #fff;">
        <div class="col-md-12 mb-3">
          <p style="color: #7e8d9f;font-size: 20px;">Invoice >> <strong>ID: #LS-<?= $transaksi->id_transaksi ?></strong></p>
          <hr>
        </div>
        <div class="col-md-12">
          ...
          <div class="col-xl-4">
            ...
            <ul class="list-unstyled">
              <li class="text-muted"><i class="fas fa-circle" style="color:#84B0CA ;"></i> <span
                  class="fw-bold">ID:#LS-</span><?= $transaksi->id_transaksi ?></li>
              <li class="text-muted"><i class="fas fa-circle" style="color:#84B0CA ;"></i> <span
        ...
        <div class="row">
          <div class="col-xl-10">
            <a href="<?= base_url('/laundry-satuan') ?>" class="btn btn-md btn-primary border-0 mb-3" style="background-color:#60bdf3 ;"><i data-feather="arrow-left"></i>Kembali</a>
          </div>
          <div class="col-xl-2">
            <form action="/export-satuan" method="post">
